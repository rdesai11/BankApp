...
<html>
    ...
    <body>
        <div class="container">
            <h1>Approved Loans</h1> <a href="LoanHome.php" class="btn btn-primary bg-primary position-fixed top-0 end-0 mt-3 me-3">Back</a>
            <table>
                <tr>
                    <th>Loan ID</th>
                    <th>Loan Number</th>
                ...
                $sql = "SELECT * FROM loanapp WHERE loanstatus = 1";
